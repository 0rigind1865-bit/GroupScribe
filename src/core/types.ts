...
export interface VisionProvider {
  ...
  // receiptCategories：1:1 私訊時帶該公司的報帳分類，讓 AI 從這份清單挑（X2-4）
  analyze(
    data: Buffer,
    mime: string,
    opts?: { receiptCategories?: readonly string[] },
  ): Promise<{ ocrText: string; summary: string; category: string; receipt?: unknown }>;
}
