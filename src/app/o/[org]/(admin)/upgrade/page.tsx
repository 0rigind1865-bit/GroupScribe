...
const PLANS = [
  { id: 'free', name: 'Free', price: '免費', groups: 1, desc: '1 個群、成員不限、AI 整理與收件匣全功能' },
  { id: 'starter', name: 'Starter', price: 'NT$690 / 月', groups: 3, desc: '3 個群、跨群「今天」總覽、每日提醒' },
  { id: 'team', name: 'Team', price: 'NT$2,190 / 月', groups: 10, desc: '10 個群、考勤模組、優先支援' },
];
  ...
  return (
    <main className="mx-auto max-w-3xl p-4 md:p-5">
      ...
      <p className="mb-4 text-sm text-gray-500">
        目前：<strong>{PLANS.find((p) => p.id === plan)?.name ?? plan}</strong> · 已認領 {used} / {max} 個群
      </p>
